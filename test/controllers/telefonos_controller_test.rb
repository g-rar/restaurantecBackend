...
class TelefonosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create telefono" do
    assert_difference('Telefono.count') do
      post telefonos_url, params: { telefono: { numtelefono: @telefono.numtelefono, restaurante: @telefono.restaurante, tipotel: @telefono.tipotel } }
    end
  ...
  test "should update telefono" do
    patch telefono_url(@telefono), params: { telefono: { numtelefono: @telefono.numtelefono, restaurante: @telefono.restaurante, tipotel: @telefono.tipotel } }
