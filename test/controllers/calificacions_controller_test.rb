...
class CalificacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create calificacion" do
    assert_difference('Calificacion.count') do
      post calificacions_url, params: { calificacion: { calificacion: @calificacion.calificacion, correousuario: @calificacion.correousuario, restaurante: @calificacion.restaurante } }
    end
  ...
  test "should update calificacion" do
    patch calificacion_url(@calificacion), params: { calificacion: { calificacion: @calificacion.calificacion, correousuario: @calificacion.correousuario, restaurante: @calificacion.restaurante } }
