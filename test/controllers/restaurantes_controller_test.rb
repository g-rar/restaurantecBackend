...
class RestaurantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create restaurante" do
    assert_difference('Restaurante.count') do
      post restaurantes_url, params: { restaurante: { calificacionrest: @restaurante.calificacionrest, latitudrest: @restaurante.latitudrest, longitudrest: @restaurante.longitudrest, nombrerest: @restaurante.nombrerest, preciorest: @restaurante.preciorest, tiporest: @restaurante.tiporest } }
    end
  ...
  test "should update restaurante" do
    patch restaurante_url(@restaurante), params: { restaurante: { calificacionrest: @restaurante.calificacionrest, latitudrest: @restaurante.latitudrest, longitudrest: @restaurante.longitudrest, nombrerest: @restaurante.nombrerest, preciorest: @restaurante.preciorest, tiporest: @restaurante.tiporest } }
