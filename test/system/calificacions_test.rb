...
class CalificacionsTest < ApplicationSystemTestCase
  ...
  test "creating a Calificacion" do
    ...
    fill_in "Calificacion", with: @calificacion.calificacion
    fill_in "Correousuario", with: @calificacion.correousuario
    fill_in "Restaurante", with: @calificacion.restaurante
