...
class UsuariosTest < ApplicationSystemTestCase
  ...
  test "creating a Usuario" do
    ...
    fill_in "Apellidousuario", with: @usuario.apellidousuario
    fill_in "Contrasenausuario", with: @usuario.contrasenausuario
    fill_in "Correousuario", with: @usuario.correousuario
    fill_in "Nombreusuario", with: @usuario.nombreusuario
